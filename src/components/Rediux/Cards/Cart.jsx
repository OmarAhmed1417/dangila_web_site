      ...
      <ul className='flex justify-center items-center flex-wrap list'  >
        {cart.map(product => (
             ...
             <div className='flex justify-center gap-4 pt-3 text-center items-center'>
               <div>
             <button className=' bg-brown_color text-white w-20 p-0' onClick={() => handleIncrement(product)}>+</button>
               </div>
             ...
             <div>
             <button className='w-20 p-0 bg-test2 text-white add' onClick={() => handleDecrement(product)}>-</button>
             </div>
             </div>
 
             <div className='flex justify-center text-center items-center mt-6 '>

<button className='w-20 bg-black text-white add p-1' onClick={() => handleRemoveFromCart(product)}>Remove</button>
</div>
